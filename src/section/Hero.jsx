  ...
  return (
    <section className='hero-section'>
        <div className='size-full mask-wrapper'>
            <img 
                src="/images/hero-bg.webp" className='scale-out' alt="background" 
            />
            <img 
                src="/images/hero-text.webp" className="title-logo fade-out" 
                alt="hero-logo"         
            />
            <img 
                src="/images/watch-trailer.png" className="trailer-logo fade-out" 
                alt="trailer" 
            />
        ...
        <div>
            <img src="/images/big-hero-text.svg" 
